...
| 🔴 | CalendarSyncManager.kt | 16.0% (8/50) | 0.0% (0/8) | 6.2% | CalendarSyncManager |
...
| 🟡 | DependencyContainer.kt | 50.5% (204/404) | N/A | 79.6% | DependencyContainer, DependencyContainer$1 |
...
| 🟡 | GeminiRequestExecutor.kt | 70.7% (174/246) | 43.6% (82/188) | 67.6% | GeminiRequestExecutor, GeminiRequestExecutor$Companion, GeminiRequestExecutor$executeWithRetry$2 |
| 🟡 | GeminiBodyBuilder.kt | 71.4% (20/28) | 100.0% (4/4) | 83.1% | GeminiBodyBuilder |
| 🟡 | DriveFileFetcher.kt | 71.4% (10/14) | N/A | 81.6% | DriveFileFetcher |
| 🟡 | CalendarPushResolver.kt | 73.3% (88/120) | 53.1% (34/64) | 75.8% | CalendarPushResolver, PushOutcome |
...
| 🟡 | ConflictResolver.kt | 77.2% (88/114) | 45.0% (36/80) | 72.7% | ConflictResolver, ConflictResolver$ConflictResolution, ConflictResolver$UnresolvedConflict |
...
| 🟢 | GeminiAIService.kt | 84.4% (238/282) | 45.0% (54/120) | 77.5% | Candidate, Candidate$Companion, Content, Content$Companion, GeminiAIService, GeminiAIService$1, GeminiAIService$Companion, GeminiAIService$TaskTier, GeminiResponse, GeminiResponse$Companion, Part, Part$Companion |
| 🟢 | Logger.kt | 85.0% (34/40) | 50.0% (6/12) | 89.9% | Logger, LoggerKt |
| 🟢 | EventGenerationService.kt | 85.5% (94/110) | 67.9% (38/56) | 78.7% | EventGenerationService |
...
| 🟢 | SourceManager.kt | 93.3% (56/60) | 50.0% (2/4) | 83.7% | SourceManager, SourceManager$loadSources$1, SourceManager$selectedSource$1 |
...
| 🟢 | CriticJsonCodec.kt | 96.8% (180/186) | 45.6% (82/180) | 78.4% | CriticJsonCodec, RawCriticEvent, RawCriticEvent$Companion, RawCriticTask, RawCriticTask$Companion |
| 🟢 | UniversalHomeLayout.kt | 96.9% (188/194) | 92.9% (26/28) | 98.9% | ComposableSingletons$UniversalHomeLayoutKt, UniversalHomeLayoutKt |
| 🟢 | GeminiResponseParser.kt | 97.9% (184/188) | 39.5% (98/248) | 75.0% | GeminiResponseParser, RawCategorization, RawCategorization$Companion, RawGeminiEvent, RawGeminiEvent$Companion, RawGeminiTask, RawGeminiTask$Companion, SourceValidationException |
...
| 🟢 | GroundingGuardAIService.kt | 100.0% (26/26) | 75.0% (6/8) | 99.4% | GroundingGuardAIService |
...
| 🟢 | GeminiErrorHandler.kt | 100.0% (24/24) | 75.0% (6/8) | 98.4% | GeminiErrorHandler |
...
| 🟢 | SemesterResolver.kt | 100.0% (34/34) | 81.8% (36/44) | 92.2% | SemesterResolver |
...
| 🟢 | SourceAdder.kt | 100.0% (84/84) | 81.3% (26/32) | 99.0% | SourceAdder, SourceAdder$addSource$1 |
...
| 🟢 | IngestionAgent.kt | 100.0% (104/104) | 81.3% (26/32) | 95.8% | IngestionAgent |
...
| 🟢 | SourceSelector.kt | 100.0% (16/16) | 75.0% (12/16) | 100.0% | SourceSelector |
