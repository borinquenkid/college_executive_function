...
| `dedupSameDateDeliverable` | 9 |
| `dedupByCommonTitlePrefix` | 9 |
| `isCompleteWordPrefix` | 4 |
| `dedup` | 3 |
| `commonPrefixLength` | 3 |
| `dateOf` | 2 |
| `stripLeakedCategoryPrefix` | 1 |
| `canonicalTitle` | 1 |
...
### AppController.kt (Score: 23.08 - 🟡 MEDIUM)
- **Total Complexity**: 23
- **Real Coverage**: 94.6%
...
### CalendarReconciler.kt (Score: 21.27 - 🟡 MEDIUM)
- **Total Complexity**: 18
- **Real Coverage**: 78.4%
...
### ResilientCalendarCleaner.kt (Score: 13.09 - 🟢 LOW)
- **Total Complexity**: 13
- **Real Coverage**: 91.9%
...
### GeminiFileUploader.kt (Score: 12.33 - 🟢 LOW)
- **Total Complexity**: 12
- **Real Coverage**: 86.8%
...
### SourceManager.kt (Score: 12.03 - 🟢 LOW)
- **Total Complexity**: 12
- **Real Coverage**: 93.9%
...
| `getPdfVisionExtractionPrompt` | 1 |
...
### CategorizationBuilder.kt (Score: 10.00 - 🟢 LOW)
- **Total Complexity**: 10
- **Real Coverage**: 100.0%
...
### SemesterFilter.kt (Score: 8.00 - 🟢 LOW)
- **Total Complexity**: 8
- **Real Coverage**: 100.0%
...
### RemoteFirstEventPersistence.kt (Score: 7.23 - 🟢 LOW)
- **Total Complexity**: 7
- **Real Coverage**: 83.3%
...
### GeminiBodyBuilder.kt (Score: 5.03 - 🟢 LOW)
- **Total Complexity**: 5
- **Real Coverage**: 90.0%
...
| `buildDocumentRequestBody` | 1 |
| `buildFileRefRequestBody` | 1 |
...
### ProgressFraction.kt (Score: 5.00 - 🟢 LOW)
- **Total Complexity**: 5
- **Real Coverage**: 100.0%
...
### SourceProcessingPipeline.kt (Score: 4.00 - 🟢 LOW)
- **Total Complexity**: 4
- **Real Coverage**: 100.0%
...
### PdfTextQuality.kt (Score: 2.00 - 🟢 LOW)
- **Total Complexity**: 2
- **Real Coverage**: 100.0%
