                        ...
                        Card(
                            ...
                            colors = CardDefaults.cardColors(
                                containerColor = when (proposal) {
                                    is SyncProposal.DirectConflict -> MaterialTheme.colorScheme.errorContainer.copy(alpha = 0.5f)
                                    is SyncProposal.StudyBlockShift -> MaterialTheme.colorScheme.secondaryContainer.copy(alpha = 0.4f)
                                }
                            )
                        ) {
                            Column(
