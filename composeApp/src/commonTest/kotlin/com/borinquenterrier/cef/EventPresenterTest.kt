...
class EventPresenterTest : FunSpec({
    ...
    test("getEventBorderColor returns correct colors for non-REGULAR categories") {
        ...
        EventPresenter.getEventBorderColor(AcademicCategory.FINALS, EventSource.MANUAL) shouldBe Color(0xFF9C27B0)
        EventPresenter.getEventBorderColor(AcademicCategory.SEMESTER_BOUND, EventSource.MANUAL) shouldBe Color(0xFF607D8B)
        EventPresenter.getEventBorderColor(AcademicCategory.STUDY_BLOCK, EventSource.MANUAL) shouldBe Color(0xFF8BC34A)
        EventPresenter.getEventBorderColor(AcademicCategory.CLASS, EventSource.MANUAL) shouldBe Color(0xFF3F51B5)
    }
    ...
    test("getEventBorderColor covers all REGULAR source branches") {
        ...
        EventPresenter.getEventBorderColor(AcademicCategory.REGULAR, EventSource.MANUAL) shouldBe Color(0xFFBDBDBD)
        EventPresenter.getEventBorderColor(AcademicCategory.REGULAR, EventSource.STUDENT) shouldBe Color(0xFFE91E63)
        EventPresenter.getEventBorderColor(AcademicCategory.REGULAR, EventSource.SCHOOL) shouldBe Color(0xFF9E9E9E)
        EventPresenter.getEventBorderColor(AcademicCategory.REGULAR, EventSource.CLASS) shouldBe Color(0xFF3F51B5)
    }
    ...
    test("getCategoryLabel returns correct labels for non-REGULAR categories") {
        ...
        EventPresenter.getCategoryLabel(AcademicCategory.FINALS, EventSource.MANUAL) shouldBe "Finals Week"
        EventPresenter.getCategoryLabel(AcademicCategory.SEMESTER_BOUND, EventSource.MANUAL) shouldBe "Semester Boundary"
        EventPresenter.getCategoryLabel(AcademicCategory.STUDY_BLOCK, EventSource.MANUAL) shouldBe "Suggested Study Period"
        EventPresenter.getCategoryLabel(AcademicCategory.CLASS, EventSource.MANUAL) shouldBe "Scheduled Class"
    }
    ...
    test("getCategoryLabel covers all REGULAR source branches") {
        ...
        EventPresenter.getCategoryLabel(AcademicCategory.REGULAR, EventSource.MANUAL) shouldBe "School Calendar"
        EventPresenter.getCategoryLabel(AcademicCategory.REGULAR, EventSource.STUDENT) shouldBe "Personal"
        EventPresenter.getCategoryLabel(AcademicCategory.REGULAR, EventSource.SCHOOL) shouldBe "Institutional"
        EventPresenter.getCategoryLabel(AcademicCategory.REGULAR, EventSource.CLASS) shouldBe "Course Item"
    }
